...
export function SidebarLogo({ collapsed }: SidebarLogoProps) {
  return (
    <Link
      to="/admin"
      className={cn(
        'flex items-center gap-3 px-3 py-4 transition-all duration-150 hover:opacity-80',
    ...
    >
      ...
      {!collapsed && (
        <div className="min-w-0">
          ...
          <p className="text-[10px] font-medium uppercase tracking-widest text-primary-300">Admin</p>
        </div>
      )}
    </Link>
  );
