  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen((v) => !v)}
        className={cn(
          'flex items-center gap-2 rounded-lg border border-neutral-200 bg-white px-3 py-1.5 transition-colors hover:bg-neutral-50',
          open && 'bg-neutral-50',
        )}
      >
        ...
        <span className="hidden max-w-[120px] truncate text-sm font-medium text-neutral-700 sm:block">
          {displayName}
        </span>
        ...
        <>
          ...
          <div className="absolute right-0 top-11 z-50 w-48 rounded-xl border border-neutral-200 bg-white shadow-lg animate-fade-in">
            <div className="border-b border-neutral-100 px-4 py-3">
              <p className="truncate text-sm font-semibold text-neutral-800">{displayName}</p>
