...
export function AttendanceHistoryPage() {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      setLoading(true);
      const { data } = await attendanceService.getByStudent(studentId, 50);
      setAttendance(data);
      setLoading(false);
    };
    void fetch();
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        <Card hover>
          <CardContent className="flex flex-col items-center gap-1 p-4 text-center">
            ...
            <p className="text-xl font-bold text-neutral-900">{stats.present}</p>
        ...
        <Card hover>
          <CardContent className="flex flex-col items-center gap-1 p-4 text-center">
            ...
            <p className="text-xl font-bold text-neutral-900">{stats.late}</p>
        ...
        <Card hover>
          <CardContent className="flex flex-col items-center gap-1 p-4 text-center">
            ...
            <p className="text-xl font-bold text-neutral-900">{stats.absent}</p>
        ...
        <Card hover>
          <CardContent className="flex flex-col items-center gap-1 p-4 text-center">
            ...
            <p className="text-xl font-bold text-neutral-900">{stats.rate}%</p>
                  ...
                  <div key={record.id} className="flex items-center gap-3 rounded-lg border border-neutral-100 p-3">
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-neutral-400">
                        ...
                        {record.manualOverride && <span className="text-neutral-400">(manually set)</span>}
                      </div>
                    </div>
